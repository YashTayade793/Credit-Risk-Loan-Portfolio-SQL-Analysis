...
* **Question 10: High-Exposure Risk Ranking by Intent**
  Identified and ranked the top highest credit exposures within each specific loan category, using a combination of CTEs and window functions to reveal borrower density at peak exposure levels.
